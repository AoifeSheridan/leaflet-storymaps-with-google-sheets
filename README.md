...
- The map is hosted by GitHub and can be found at https://aoifesheridan.github.io/leaflet-storymaps-with-google-sheets/
- Google Sheets template:'https://docs.google.com/spreadsheets/d/1DBSYvWpydbZTO180nLzKopdBje6xlZX6OOX5mY_FlRs/edit#gid=0;
